    ...
    <section className="view view-planner">
      <div className="view-head">
        <div>
          ...
          <p className="view-sub">Each slot is <b>one serving</b> you eat that day — most recipes batch-cook 4–5, so use the <b>＋ / −</b> on a meal to log how many servings you'll eat. Your shopping list rounds up to whole batches.</p>
        </div>
